...
export default function EditorialLoginPage() {
  ...
  return (
    <>
      ...
      <div style={{ minHeight: '100dvh', display: 'flex', flexDirection: 'column', background: '#f9f9f9' }}>
          ...
          <div style={{ width: '100%', maxWidth: 440 }}>
            ...
            <section style={{ marginBottom: 48 }}>
              <p style={{
                ...
                textTransform: 'uppercase', color: '#5d5f5f', marginBottom: 12,
              }}>
                Editorial
              </p>
              <h2 style={{
                fontFamily: "'Bodoni Moda', Georgia, serif",
                fontSize: 32, fontWeight: 500, color: '#000', marginBottom: 12,
              }}>
                Welcome back.
              </h2>
            ...
            <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 40 }}>
              <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
                <label style={{ fontSize: 11, letterSpacing: '0.15em', fontWeight: 600, textTransform: 'uppercase', color: '#000' }}>
                  EMAIL
                </label>
                <input
                  className="cf-input"
              ...
              {error && (
                <p style={{ fontSize: 13, color: '#ba1a1a', marginTop: -16 }}>{error}</p>
              )}
        ...
        <footer style={{
          ...
          <p style={{ fontSize: 11, letterSpacing: '0.12em', color: '#5d5f5f', textTransform: 'uppercase' }}>
